    ...
    <Box>
      ...
      <Flex flexDirection="column" bg="#f9f1e8">
        ...
        <Box height={12} bg="#f9f1e8">
         ...
         <Box position="relative" height="1px" bgGradient="linear(to-r, black,black)">
            <Box position="absolute" top="-12px" left="100px" width="130px" height="25px" bg="brand.50" paddingX={2}   fontFamily="Montserrat, sans-serif" color="black" fontWeight="extrabold">Action and</Box>
            <Box position="absolute" top="-12px" left="205px" width="110px" height="25px" bg="brand.50" paddingX={2}   fontFamily="Montserrat, sans-serif" color="white" fontWeight="extrabold">Adventure</Box>
        </Box>
        <Box width="100%" marginTop={8} marginBottom={8}>
            <Carousel cardData={cardData} />
        </Box>
        ...
        <Box height={12} bg="#f9f1e8">
         ...
         <Box position="relative" height="1px" bgGradient="linear(to-r, black,black)">
            <Box position="absolute" top="-12px" left="100px" width="130px" height="25px" bg="brand.50" paddingX={2}   fontFamily="Montserrat, sans-serif" color="black" fontWeight="extrabold">Blockbuster</Box>
            <Box position="absolute" top="-12px" left="218px" width="90px" height="25px" bg="brand.50" paddingX={2}   fontFamily="Montserrat, sans-serif" color="white" fontWeight="extrabold">Movies</Box>
        </Box>
        <Box width="100%" marginTop={8} marginBottom={8}>
            <Carousel cardData={cardData} />
        </Box>
